              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div>
                  ...
                  <p className="text-indigo-100">
                    จัดการเนื้อหาและโพสต์ของคุณได้ที่นี่
                  </p>
                </div>
                  ...
                  {postData && postData.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {postData.map((val) => (
                        <Link href={`/post/${val._id}`} key={val._id}>
                          <div className="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                      ...
                      <p className="text-gray-500 mb-4">
                        คุณยังไม่มีโพสต์ในระบบ เริ่มสร้างโพสต์แรกของคุณเลย
                      </p>
                      <Link
                        href="/create"
